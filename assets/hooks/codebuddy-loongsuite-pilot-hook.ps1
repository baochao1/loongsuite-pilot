# CodeBuddy hook entrypoint for Windows.
#
# Registered command:
#   powershell.exe -NoProfile -NonInteractive -ExecutionPolicy Bypass `
#     -File "<pilot-data>\hooks\codebuddy-loongsuite-pilot-hook.ps1" <subcommand>
#
# The hook is fail-open: it always acknowledges CodeBuddy with one JSON object
...
$Processor = Join-Path $ScriptDir "codebuddy-hook-event-writer.mjs"
